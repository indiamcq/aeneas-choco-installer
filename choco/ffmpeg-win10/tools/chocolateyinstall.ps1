...
$packageName = 'ffmpeg-win10'
$url = 'http://ffmpeg.zeranoe.com/builds/win32/shared/ffmpeg-2.7-win32-shared.7z'
$url64 = 'http://ffmpeg.zeranoe.com/builds/win64/shared/ffmpeg-2.7-win64-shared.7z'
